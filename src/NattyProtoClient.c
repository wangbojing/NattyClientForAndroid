	...
	while (1) {
		...
		if (ret) {
			...
			if (buf[NTY_PROTO_TYPE_IDX] == NTY_PROTO_LOGIN_ACK) {
				...
				//LOG(" recByteCount:%d, %d\n", recByteCount, proto->recvLen);
